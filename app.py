...
# st.title("🦠 Disease Coverage Dashboard (Chuquisaca)")
# 
# # =========================================
# # 3. 데이터 로드
# # =========================================
...
# col3.metric("위험 지역 수", int(risk_count))
# 
# # =========================================
# # 6. TOP5
# # =========================================
...
#         fields=["municipio_x", disease, "viv_roc", "viv_exist"],
#         aliases=["지역", "값", "방역", "전체"]
#     )
# ).add_to(m)
# 
...
#     if row[disease] < threshold:
#         centroid = row["geometry"].centroid
#         folium.Marker(
#             location=[centroid.y, centroid.x],
#             icon=folium.DivIcon(
#                 html=f"<div style='color:red;font-size:10px;'>⚠ {row['municipio_x']}</div>"
#             )
#         ).add_to(m)
# 
...
map.save("chuquisaca_map.html")
files.download("chuquisaca_map.html")