...
# =========================================
# 13. MAP + FLOATING LEGEND (Fixed Markdown)
# =========================================
st.subheader("🗺️ Mapa")

col_map, col_legend = st.columns([4, 1]) # 비율을 살짝 조정하여 범례 공간 확보
...
if disease == "dengue":
    ...
    if len(monthly) > 0:
        month_map = {1:"Ene",2:"Feb",3:"Mar",4:"Abr",5:"May",6:"Jun",7:"Jul",8:"Ago",9:"Sep",10:"Oct",11:"Nov",12:"Dic"}
        monthly["Mes_nombre"] = monthly["Mes"].map(month_map)
        st.plotly_chart(px.line(monthly, x="Mes_nombre", y="value", markers=True), use_container_width=True)
